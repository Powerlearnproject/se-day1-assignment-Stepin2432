...
Milestone: The development of structured programming techniques was one of the major advancements in software engineering. Before structured programming, early software development was largely unstructured, with "spaghetti code" and jump statements like GOTO leading to hard-to-maintain and error-prone code. The 1960s and 1970s saw the introduction of structured programming concepts, promoted by figures like Edgar Dijkstra and Niklaus Wirth.
Key Contributions:
...
A focus on close collaboration with customers, responding to change, and delivering small, frequent releases of functional software.
Impact: Agile methodologies significantly changed how teams work on software projects, promoting flexibility, continuous improvement, and faster delivery. It also emphasized the importance of individuals and interactions over processes and tools, fostering a more dynamic and adaptive approach to development.
Other Notable Milestones:
Object-Oriented Programming (OOP) in the 1980s, popularized by languages like C++ and Java, which introduced the concept of encapsulation, inheritance, and polymorphism.
The development of DevOps practices in the 2000s, which sought to bridge the gap between software development and IT operations, enabling faster and more reliable software deployment.
These milestones represent a few of the major turning points that have defined the evolution of software engineering, helping the field grow in both technical complexity and professional maturity.

List and briefly explain the phases of the Software Development Life Cycle.
planning - identify the software requirement or purpose and scope. requirement analysis - identify the final user specification. 
